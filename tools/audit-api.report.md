...
- Generated: `2026-01-24T20:48:42.202Z`
...
|---|---:|:---:|---|---|---|
| T1 public GET /api/debug | 404 | ✅ |  | Expected: 401 or 404 (never 200) | `https://big-day-five.vercel.app/api/debug` |
| T2 public POST /api/config/mesas | 401 | ✅ |  | Expected: 401/403 (or 404 if endpoint not present) | `https://big-day-five.vercel.app/api/config/mesas` |
| T2 public POST /api/config/buses | 401 | ✅ |  | Expected: 401/403 (or 404 if endpoint not present) | `https://big-day-five.vercel.app/api/config/buses` |
...
| T3a public GET /api/invitados?token=... (RSVP read) | 404 | ✅ |  | Expected: 200 (token exists) OR 404 (token not found) | `https://big-day-five.vercel.app/api/invitados?token=tok_****8c32` |
...
| T3c PATCH /api/rsvp without token (should 400) | 400 | ✅ |  | Expected: n/a | `https://big-day-five.vercel.app/api/rsvp` |
| T3d PATCH /api/rsvp with token (optional) |  | ✅ | skipped: Writes disabled (localhost only) | Expected: n/a |  |
| T3e PATCH /api/rsvp twice (optional) |  | ✅ | skipped: Writes disabled (localhost only) | Expected: n/a |  |
